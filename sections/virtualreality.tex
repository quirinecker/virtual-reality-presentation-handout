...
Wie bereits in Abschnitt~\ref{sec:arten-von-headsets} beschrieben, gibt es von diesen Headsets verschiedene Modelle.
...
Diese befindet sich genauso wie die HTC Vive Pro~\ref{sec:htc-vive} im teureren Spektrum~\cite{ALSOP_2019} der VR-Brillen und ist dem Typ tethered Headset~\ref{sec:arten-von-headsets} zuzuordnen.
...
Diese Brille ist eine Mischung von einem tethered Headset und einem Standalone Headset~\ref{sec:arten-von-headsets}.
...
Zum Zeitpunkt das Verfassen der Präsentation gibt es 2 Versionen der Base Stations.
...
\begin{itemize}
    \item Unreal Engine (Programmiersprache: C++)
    \item Unity Engine (Programmiersprache: C#)
    \item Source 2 Engine (Programmiersprache: Lua)
\end{itemize}
